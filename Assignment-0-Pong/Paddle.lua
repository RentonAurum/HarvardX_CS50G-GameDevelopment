...
-- Impl_Func_ComPaddle.
-- Func Paddle has ball as parameter, so the Y-Axis of the ComputerPaddle will always change
-- according to the Y-Axis of the Ball, and the ball will always hit the center of the
-- ComputerPaddle.
