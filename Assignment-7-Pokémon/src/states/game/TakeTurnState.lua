            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local hpUP, defUP, atkUP, spdUP = self.playerPokemon:levelUp()
                        gStateStack:push(BattleMessageState('Congratulations! Level Up!',
                        function()

                            local menuLevel = Menu {
                                x = 64*4,
                                y = 0,
                                width = 64*2,
                                height = 160,
                                ...
                                items = {
                                    ...
                                    {
                                        text = self.playerPokemon.HP - hpUP .. ' + ' .. hpUP .. ' ===> ' .. self.playerPokemon.HP
                                    },
                                    {
                                        text = 'Defense '
                                    },      
                                    {
                                        text = self.playerPokemon.defense - defUP .. ' + ' .. defUP .. ' ===> ' .. self.playerPokemon.defense
                                    },                                  
                                    {
                                        text = 'Attack '
                                    },
                                    {
                                        text = self.playerPokemon.attack - atkUP .. ' + ' .. atkUP .. ' ===> ' .. self.playerPokemon.attack
                                    },
                                    {
                                        text = 'Speed '
                                    },
                                    {
                                        text = self.playerPokemon.speed - spdUP .. ' + ' .. spdUP .. ' ===> ' .. self.playerPokemon.speed
                                    }
                                }
                            ...
                            gStateStack:push(LevelUpShow(menuLevel, function()
                                gStateStack:pop()
                                self.fadeOutWhite()
                            end))
                            --self:fadeOutWhite()
